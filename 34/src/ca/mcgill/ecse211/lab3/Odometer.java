...
public class Odometer implements Runnable {
  ...
  private double distL, distR, dDist, dTheta, dX, dY; //Position-related variables
  
  // Motor-related variables
  private static int leftMotorTachoCount = 0;
  private static int rightMotorTachoCount = 0;
  private static int prevLeftMotorTachoCount, prevRightMotorTachoCount;
  ...
  public void run() {
    ...
    while (true) {
      ...
      distL = Math.PI *(WHEEL_RADIUS) *(leftMotorTachoCount - prevLeftMotorTachoCount)/180;
      distR = Math.PI *(WHEEL_RADIUS) *(rightMotorTachoCount - prevRightMotorTachoCount)/180;
