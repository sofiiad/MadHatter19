...
import static ca.mcgill.ecse211.lab4.Resources.CM_ERR;
import static ca.mcgill.ecse211.lab4.Resources.DEG_ERR;
...
public class Navigation {
  ...
  /**
   * boolean variable that will be used to indicate if EV3 is still navigating
   * through the course
   */
  private static boolean navigating;

  /**
   * Instantiating interrupt variable to false. This indicates that there is no
   * initial obstacle in front of the EV3
   */
  ...
  /**
   * // * Moves robot forward a set distance in cm. Used for navigation with
   * obstacle avoidance setting // * // * @param distance // * @param avoid //
   */
  ...
  /**
   * Moves robot forward a set distance in cm. Used for navigation without
  ...
  /**
   * Travels a certain amount of cm given distance in the reverse sense (backwards)
   * 
   * @param distance
   */
  static void travelBack(double distance) {
    double dX, dY;
    last_X = odometer.getX();
    last_Y = odometer.getY();
    travelBackward();
  ...
  /**
   * Travels backward without stopping
   */
  static void travelBackward() {
    navigating = true;
   ...
   * 
   */
  public static void rotate(boolean clockwise) {
